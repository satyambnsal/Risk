class GameScene extends Phaser.Scene {
    ...
    createTerritories() {
        // Define simplified territories (in a real game, you would have more with proper shapes)
    ...
    setupAdjacencyMap() {
        // Define which territories are adjacent (simplified for this example)
        this.adjacencyMap = {
    ...
    updateGameInfo() {
        ...
        this.playerText.setColor(this.rgbToHex(currentPlayer.color));
    ...
    endTurn() {
        ...
        // Move to reinforcement phase (simplified as 'placement')
        window.gameVars.gamePhase = 'placement';
    ...
    handleTerritoryClick(territory) {
        ...
        if (window.gameVars.gamePhase === 'placement') {
            ...
            if (window.gameVars.selectedTerritory === null) {
                ...
                // Selecting the defending territory
            ...
            if (window.gameVars.selectedTerritory === null) {
                ...
                if (territory.owner === currentPlayer.id &&
                    ...
                    window.gameVars.selectedTerritory.setSelected(false);
                    window.gameVars.selectedTerritory = null;
                    this.actionText.setText('Invalid target. Select territory to move armies from or end turn');
                }
            }
        }
    }
    ...
    fortifyTerritory() {
        ...
        // Move armies (simplified - moves half of armies)
    ...
    gameOver(winnerIndex) {
        ...
        this.add.text(600, 425, `Player ${winnerIndex + 1} Wins!`, {
            fontSize: '32px',
            fill: this.rgbToHex(window.gameVars.players[winnerIndex].color)
        }).setOrigin(0.5);
